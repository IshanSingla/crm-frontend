...
export default function BusinessCard({ val, updater, setUpdater, key }) {
    ...
    >
      ...
      >
        ...
        <div
          ...
          } flex gap-1 place-self-end justify-end absolute bottom-2 right-2  rounded-full p-2`}
          onClick={handleDelete}
        >
          <img
            src={theme ? deletedark : deletedark}
            alt="delete"
            className={`w-4 h-4`}
          />
        </div>
