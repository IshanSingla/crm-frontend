...
export default function Services() {
  return (
    <div className="bg-secBlue relative py-20 px-10 min-h-screen flex flex-col space-y-10 items-center justify-center rounded-md border border-grey2 overflow-hidden">
